...
Tutorial is demonstrating the typical process of editing content that has been previously posted on the blockchain. Instead of replacing the entire body of the post, the Steem blockchain offers an alternative strategy. Since HF20 even archived content (older than 7 days) can be changed/updated. This is helpful to increase the accuracy of content on the blockchain. Editing content will also use less RC (resource credits) than creating new posts entirely.
